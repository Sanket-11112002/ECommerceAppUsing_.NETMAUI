...
@dso_cache = dso_local local_unnamed_addr global [666 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 167762867, ; hash 0x9ffdbb3, from name: DemoEcommerce.Library.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 306982471, ; hash 0x124c2e47, from name: libaot-DemoEcommerce.Library.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DemoEcommerce.Library.dll.so
		ptr null; void* handle (0x0)
	}, ; 48
	...
	%struct.DSOCacheEntry {
		i64 774538360, ; hash 0x2e2a8478, from name: aot-DemoEcommerce.Client.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1038269218, ; hash 0x3de2bb22, from name: libaot-DemoEcommerce.Client.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-DemoEcommerce.Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 156
	...
	%struct.DSOCacheEntry {
		i64 2199940231, ; hash 0x83206c87, from name: aot-DemoEcommerce.Library.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DemoEcommerce.Library.dll.so
		ptr null; void* handle (0x0)
	}, ; 325
	...
	%struct.DSOCacheEntry {
		i64 2233398935, ; hash 0x851ef697, from name: DemoEcommerce.Library
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DemoEcommerce.Library.dll.so
		ptr null; void* handle (0x0)
	}, ; 333
	...
	%struct.DSOCacheEntry {
		i64 3384393248, ; hash 0xc9b9be20, from name: aot-DemoEcommerce.Client
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-DemoEcommerce.Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 530
	...
	%struct.DSOCacheEntry {
		i64 3397737757, ; hash 0xca855d1d, from name: libaot-DemoEcommerce.Library
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DemoEcommerce.Library.dll.so
		ptr null; void* handle (0x0)
	}, ; 533
	...
	%struct.DSOCacheEntry {
		i64 3567518853, ; hash 0xd4a40485, from name: libaot-DemoEcommerce.Client
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-DemoEcommerce.Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 555
	...
	%struct.DSOCacheEntry {
		i64 3766610050, ; hash 0xe081e882, from name: aot-DemoEcommerce.Library
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DemoEcommerce.Library.dll.so
		ptr null; void* handle (0x0)
	}, ; 583
	...
	%struct.DSOCacheEntry {
		i64 4094432848, ; hash 0xf40c1650, from name: DemoEcommerce.Client.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-DemoEcommerce.Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 631
	...
	%struct.DSOCacheEntry {
		i64 4134144668, ; hash 0xf66a0a9c, from name: DemoEcommerce.Client
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-DemoEcommerce.Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 641
